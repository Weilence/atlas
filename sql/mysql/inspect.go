...
ORDER BY
	...
	myChecksQuery = `SELECT t1.TABLE_NAME, t1.CONSTRAINT_NAME, t2.CHECK_CLAUSE, t1.ENFORCED
FROM
...
ORDER BY
	...
	marChecksQuery = `SELECT TABLE_NAME, CONSTRAINT_NAME, CHECK_CLAUSE, "YES" AS ENFORCED
FROM
	INFORMATION_SCHEMA.CHECK_CONSTRAINTS AS t2
WHERE
	LEVEL = 'Column'
